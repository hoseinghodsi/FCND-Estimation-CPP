...
void QuadEstimatorEKF::UpdateFromIMU(V3F accel, V3F gyro)
{
  ...
  rotation_mat(2, 0) = 0;
  rotation_mat(2, 1) = sin(phi) * 1 / cos(theta);
  rotation_mat(2, 2) = cos(phi) * 1 / cos(theta);
...
void QuadEstimatorEKF::Predict(float dt, V3F accel, V3F gyro)
{
  ...
  //gPrime(3, 6) = (RbgPrime(0, 1) * accel.x + RbgPrime(0, 2) * accel.y + RbgPrime(0, 3) * accel.z)* dt;
  //gPrime(4, 6) = (RbgPrime(1, 1) * accel.x + RbgPrime(1, 2) * accel.y + RbgPrime(1, 3) * accel.z)* dt;
  //gPrime(5, 6) = (RbgPrime(2, 1) * accel.x + RbgPrime(2, 2) * accel.y + RbgPrime(2, 3) * accel.z)* dt;
